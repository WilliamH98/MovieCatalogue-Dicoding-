...
public class MovieViewModel extends ViewModel {
    ...
    public void setMovies(String locale, final Context context) {
        GetMoviesServices moviesService = RetrofitClientInstance.getRetrofitClientInstance().create(GetMoviesServices.class);
        Call<APIMovieModel> callList = moviesService.getMovieAPIData(String.format("movie?api_key=%s&language=%s", BuildConfig.API_KEY, locale));
